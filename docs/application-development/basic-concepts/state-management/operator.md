...
For additional information please refer to the [ArkTS Two Way Sync](https://github.com/eclipse-oniro-mirrors/docs/blob/OpenHarmony-5.0.2-Release/en/application-dev/quick-start/arkts-two-way-sync.md)